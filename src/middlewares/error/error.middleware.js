...
const convertValidationError = (err) => {
  ...
  err.details.forEach((error) => {
    formattedErrors.push(generateError('VALIDATION_ERROR', 'We seems to have a problem!', error.message));
  });
...
const convertGenericError = (err) => {
  const wrappedError = generateError('UNCAUGHT', 'Seems we have a problem!', err.message);
